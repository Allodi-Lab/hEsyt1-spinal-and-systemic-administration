...
#filtering p45 away since it was a training day before testing
...
#If any files have SIDEVIEW in their names, this is removed
...
df2$Genotype <- ifelse(grepl('491_', df2$Name), 'WT', df2$Genotype) 
...
df2$time_point <- as.factor(df2$time_point) 
...
DunnettTest(x=onset_all$PeakAcc., g=onset_all$Genotype) 
